          ...
          <div className="container relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg text-gray-300">
                Ihr vertrauenswürdiger Partner für globale Logistik und Lieferkettenlösungen.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>
                  ...
                  maßgeschneiderte End-to-End-Fracht- und Fulfillment-Lösungen, die auf die Bedürfnisse des modernen
                  Handels zugeschnitten sind. Ob per Luft, See oder Straße – wir liefern schnelle, zuverlässige und
                  kosteneffektive Transporte, unterstützt durch starke Partnerschaften mit lokalen Spediteuren und tiefe
                  Integration mit Fulfillment-Netzwerken.
                </p>
                <p className="mt-4">
                  Wir setzen uns für nachhaltige Logistik ein, optimieren aktiv Routen, konsolidieren Sendungen und
                  erkunden umweltfreundlichere Transportoptionen, um unseren CO2-Fußabdruck zu reduzieren. Gleichzeitig
                  investieren wir in digitale Infrastruktur und bauen intelligente Systeme auf, die Transparenz,
                  Automatisierung und Kundenerfahrung in der gesamten Lieferkette verbessern.
                </p>
                <p className="mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Wir entwickeln unsere Dienstleistungen und Technologien ständig weiter, um Branchentrends und Kundenbedürfnissen immer einen Schritt voraus zu sein.",
                },
                {
          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Wir bieten ein komplettes Spektrum an Logistiklösungen zur Unterstützung Ihrer globalen
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-8">
                <Button asChild size="lg" className="bg-white text-[#18794E] hover:bg-gray-100">
                  <Link href="/de/contact">Starten Sie noch heute</Link>
                </Button>
              </div>
            </div>
          </div>
