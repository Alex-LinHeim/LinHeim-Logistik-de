...
const services = [
  {
    ...
    title: "Seefracht",
    description: "Zuverlässiger Seetransport für globale Import- und Exportbedürfnisse.",
    link: "/de/services/sea-freight",
  },
  {
    icon: <Truck className="h-8 w-8 md:h-10 md:w-10" />,
    title: "Landtransport",
    description: "Schnelle und sichere LKW-Lieferung in ganz Europa und darüber hinaus.",
    link: "/de/services/land-transport",
  },
  {
    icon: <Plane className="h-8 w-8 md:h-10 md:w-10" />,
    title: "Luftfracht",
    description: "Express-Luftfrachtlösungen mit globaler Reichweite.",
    link: "/de/services/air-freight",
  },
  {
    icon: <FileCheck className="h-8 w-8 md:h-10 md:w-10" />,
    title: "Zollabfertigung",
    description: "Problemlose Zollabwicklung mit Expertenkonformität.",
    link: "/de/services/customs",
  },
  {
    icon: <Warehouse className="h-8 w-8 md:h-10 md:w-10" />,
    title: "Lagerhaltung",
    description: "Sichere Lagerung und intelligentes Bestandsmanagement.",
    link: "/de/services/warehousing",
  },
  {
    icon: <Package className="h-8 w-8 md:h-10 md:w-10" />,
    title: "Logistiklösung",
    description: "Maßgeschneiderte End-to-End-Logistikdienste für jedes Unternehmen.",
    link: "/de/services/logistics-solution",
  },
]
      ...
      <div className="flex justify-center mt-6 space-x-3">
        {services.map((_, index) => (
          <button
            ...
            aria-label={`Zu Service ${index + 1} gehen`}
            disabled={isAnimating}
          />
        ))}
      </div>
